...
public class EntityFloatGetterParameterNode : Node
{
    string[] attributeNames=new string[]{"health","speed"};
    ...
    public override void SetBody(GameObject body_input, GameObject body_output)
    {
        ...
        var _out=this.FloatGetterOutputPort("out getter",() => new EntityFloatGetter(nodeEditorController.targetEntity,selectedAttributeName??attributeNames[0]), body_output, out GameObject port2);
        //
        deleteAction=() => {
            _out.Delete();
        };
    ...
    public override void SetHeader(GameObject header)
    {
        ...
        textComponent.text = "Entity Float Getter";
